...
targetDir = strcat(currentDir, '\AllResults\EffectofDL')
...
DLList = [0.05, 0.06, 0.07, 0.08, 0.09, 0.10]
...
writematrix(finalTheta, strcat('DL', num2str(DL), 'thetaList.csv'));
writematrix(finalBeta, strcat('DL', num2str(DL), 'betaList.csv'));
end
cd(currentDir)